...
_C.TOOLBOX_MODE = ""
_C.TRAIN = CN()
_C.TRAIN.LQ_EPOCHS = 30
_C.TRAIN.C2F_EPOCHS = 50
_C.TRAIN.BATCH_SIZE = 4
_C.TRAIN.LR_LQ = [1e-4, 1e-4, 1e-4, 1e-4]
_C.TRAIN.LR_C2F = 1e-3
_C.TRAIN.LR_cls = 1e-3
_C.TRAIN.LQ_Alpha = 0.01
_C.TRAIN.LQ_Beta = 1.0
_C.TRAIN.C2F_Alpha = 1.0
_C.TRAIN.C2F_Beta = 1.0
_C.TRAIN.C2F_Gamma = 1.0
_C.TRAIN.AUG = 0
# Train stage
_C.TRAIN.LQ_PRETRAINED = False
_C.TRAIN.LQ_PRETRAINED_PATH = None
_C.TRAIN.C2F_PRETRAINED = False
_C.TRAIN.C2F_PRETRAINED_PATH = None
...
_C.MODEL.MODEL_DIR = './usr_PreTrainedModels'
